...
def send_udp_broadcast():
    ...
    try:
        ...
        # Also try logging host specifically
        sock.sendto(message.encode('utf-8'), ('127.0.0.1', BACKEND_UDP_PORT)) 
...
def update_backend_state():
    ...
    try:
        ...
        resp = requests.post(f"{BACKEND_HTTP_URL}/table/state", json=robot_state, headers=headers)
